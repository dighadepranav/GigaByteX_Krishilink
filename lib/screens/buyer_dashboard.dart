...
class _BuyerDashboardState extends State<BuyerDashboard> {
  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      _userName = prefs.getString('userName') ?? 'Buyer';
      _userPhone = prefs.getString('userPhone') ?? '';
      _userLocation = prefs.getString('userLocation') ?? 'Mumbai, Maharashtra';
  ...
  String _statusLabel(String status, BuildContext context) {
    ...
    switch (status) {
      case 'delivered':
        return l10n?.translate('delivered') ?? 'Delivered';
      case 'in_transit':
        return l10n?.translate('in_transit') ?? 'In Transit';
      case 'confirmed':
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
                ...
                label: l10n?.translate('my_orders') ?? 'My Orders'),
            BottomNavigationBarItem(
        ...
        floatingActionButton: _selectedIndex == 0
            ? FloatingActionButton.extended(
                ...
                label: Text(l10n?.translate('browse_market') ?? 'Browse Market',
              ...
              children: [
                ...
                Expanded(
                    child: Column(
                        ...
                        children: [
                      Text(
                          '${l10n?.translate('hello') ?? 'Welcome'}, $_userName!',
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 18,
                ...
                Column(children: [
                  ...
                  Text(_userLocation.split(',').first,
                      style:
  ...
  Widget _buildOrdersTab() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) =>
          _buildOrderCard(_orders[index], cardColor),
    );
  }

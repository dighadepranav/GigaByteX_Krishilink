  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Browse Market', style: TextStyle(color: Colors.white)),
      ),
    );
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    const Text('Mumbai', style: TextStyle(color: Colors.white70, fontSize: 10)),
                  ],
                ),
              ],
            ),
          ...
          Row(
            children: [
              Expanded(child: _buildStatCard('Total Orders', '0', Icons.shopping_bag, kBlue, isDark)),
              const SizedBox(width: 12),
              Expanded(child: _buildStatCard('Active', '0', Icons.local_shipping, Colors.orange, isDark)),
              const SizedBox(width: 12),
              Expanded(child: _buildStatCard('Spent', '₹0', Icons.currency_rupee, Colors.green, isDark)),
            ],
          ),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    const Text('Mumbai, Maharashtra', style: TextStyle(color: Colors.white70, fontSize: 12)),
                  ],
                ),
                const SizedBox(height: 12),
                Container(
                  ...
                  child: const Text('🛒  Buyer', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
          ),
          const SizedBox(height: 20),
          _profileTile(Icons.shopping_bag_rounded, 'My Orders', '0 orders', kBlue, cardColor, () {}),
          _profileTile(Icons.storefront_rounded, 'Marketplace', 'Browse fresh produce', Colors.green, cardColor, () {}),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('$title coming soon', style: TextStyle(color: Colors.grey.shade500, fontSize: 16)),
        ],
      ),
    );
  }
